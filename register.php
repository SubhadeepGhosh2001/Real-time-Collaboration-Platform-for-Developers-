...
<head>
    ...
    <style>
        * {
        ...
        .button-wrapper {
            margin-top: 1rem; /* Add this rule for spacing */
        }
                        ...
                        <div class="form-content">
                            ...
                            <form method="POST" action="register.php">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="name" name="name" placeholder="Enter your username" value="<?php echo isset($_POST['name']) ? htmlspecialchars($_POST['name']) : ''; ?>">
                                </div>
                                <div class="input-group">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function checkFormValidity() {
                ...
                registerBtn.disabled = !(name && email && password && confirmPassword && password === confirmPassword);
            }
